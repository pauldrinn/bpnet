...
# ------------------------------------
# COPIED WITH MINOR MODIFICATIONS FOR TF2 COMPATIBILITY
# FROM https://github.com/kundajelab/DeepExplain 
# WHICH IS A FORK OF https://github.com/marcoancona/DeepExplain
# ------------------------------------
